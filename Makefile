...
build: ## Build the server, CLI, migrate, and Mattermost-bot binaries into server/bin
	...
	cd server && go build -o bin/multica-mattermost-bot ./cmd/multica-mattermost-bot
