...
const configureNav: { key: NavKey; labelKey: NavLabelKey; icon: typeof Inbox }[] = [
  ...
  { key: "load", labelKey: "load", icon: Activity },
...
export function AppSidebar({ topSlot, searchSlot, headerClassName, headerStyle }: AppSidebarProps = {}) {
  ...
  // PUL-481: badge served by /api/inbox/unread-count so the sidebar doesn't
  // have to fetch the full inbox to render one number. Server dedupes to
  // match the inbox list's per-issue semantics.
